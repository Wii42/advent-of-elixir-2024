...
defmodule AdventOfElixir2024.Day12_1 do
  @moduledoc "Solution for day 12, part 1 of Advent of Code 2024"
  ...
  def solution(input) do
    ...
    Enum.map(regions, fn region -> length(region) * length(get_region_perimeter(region)) end)
    |> Enum.sum()
  end
...
AdventOfElixir2024.Day12_1.prod()
