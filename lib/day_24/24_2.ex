defmodule AdventOfElixir2024.Day24_2 do
  @moduledoc "Solution for day 24, part 2 of Advent of Code 2024"
  ...
  def solution(input) do
    ...
    number1 = get_value(initial_wires, "x")
    number2 = get_value(initial_wires, "y")
...
AdventOfElixir2024.Day24_2.prod()
